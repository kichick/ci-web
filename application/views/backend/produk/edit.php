                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id_produk" id="id_produk" value="<?= $product['id_produk'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-grup col-sm-5">
                                    <select name="id_kategori_gender" id="id_kategori_gender" class="form-control" value="<?= $product['id_kategori_gender'] ?>">
                                ...
                                <div class="form-grup col-sm-5 ">
                                    <select name="id_kategori_item" id="id_ketogori_item" class="form-control" value="<?= $product['id_kategori_item'] ?>">
